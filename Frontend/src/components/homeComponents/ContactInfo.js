        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
          <div class="col">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5 class="card-title">6 Facts You Should Know Before Owning An Orient Watch</h5>
                <p class="card-text">If you are looking for a high-quality and affordable watch, an Orient Watch will be a perfect choice for you. Before getting an Orient watch on hand, you may need to know a few things more about Orient watches.</p>
              </div>
              <div class="card-footer d-flex justify-content-between ">
                <small class="text-muted">Last updated 1 month ago</small>
                <a className="card-link  text-primary " href="https://bestwatch.sg/blog/watchguide/orient-watch/">Continue reading...</a>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5 class="card-title">Luxury Watches: Top 20 Luxury Watch Brands & Their Collections</h5>
                <p class="card-text">Discover the world of luxury watches like never before. Explore the top 20 luxury watch brands & each of their collections.</p>
              </div>
              <div class="card-footer d-flex justify-content-between ">
                <small class="text-muted">Last updated 5 day ago</small>
                <a className="card-link  text-primary " href="https://wristadvisor.com/luxury-watches-top-watch-brands/">Continue reading...</a>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5 class="card-title">20 Couple Watch Idea to Buy for Yourself or to Gift on Someone's Wedding</h5>
                <p class="card-text">Couple watch is the best thing to gift to your friend or family. And even a couple can also buy branded couple watch set for their own wedding. To make it easy for you we have made a collection of some of the luxurious couple watches and some from affordable ranges.</p>
              </div>
              <div class="card-footer d-flex justify-content-between ">
                <small class="text-muted">Last updated 5 day ago</small>
                <a className="card-link  text-primary " href="https://www.bookeventz.com/blog/couple-watch-wedding-gift-ideas/">Continue reading...</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container-fluid pt-5 text-contact" id="Contact"> 
        ...
        <div class="row px-xl-5">
          ...
          <div class="col-lg-5 mb-5 ">
            ...
            <p>Our store has only one branch. See our contact information below!</p>
            <div class="d-flex flex-column mb-3 mt-2">
              <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Le Duan Street, Hai Chau 2, Hai Chau, Da Nang 550000, Vietnam</p>
              <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>goldentime@gmail.com</p>
              <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+84 788 030 999</p>
            </div>
          </div>
        </div>
        <hr />
              ...
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <p class="card-text">123 Le Duan Street, Hai Chau 2, Hai Chau, Da Nang 550000, Vietnam</p>
                  </div>
                </div>
              </div>
            </div>
